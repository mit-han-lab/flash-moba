 ...
 * Adapted by Junxian Guo from https://github.com/Dao-AILab/flash-attention/blob/main/csrc/flash_attn/src/utils.h
...
#else
    Tensor out = FLASH_MOBA_NAMESPACE::convert_type<To_type>(tensor);
    FLASH_MOBA_NAMESPACE::relu_(out);
#endif
    return out;
}
